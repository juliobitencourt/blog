...
Você pode [habilitar verificações de status obrigatórias](https://help.github.com/pt/github/administering-a-repository/enabling-required-status-checks) ou configurar  no Bitbucket.
